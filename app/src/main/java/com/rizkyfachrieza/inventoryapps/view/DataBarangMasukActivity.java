...
public class DataBarangMasukActivity extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnTambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(DataBarangMasukActivity.this, TambahDataBarangMasukActivity.class);
    ...
    public void initData() {
        Cursor data = sqliteHelper.getAllBarangMasuk();
//        Toast.makeText(getApplicationContext(), DatabaseUtils.dumpCursorToString(data), Toast.LENGTH_LONG).show();
            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                    ...
                    if (viewId == R.id.btnEdit) {
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(DataBarangMasukActivity.this);
                        ...
                        builder.setPositiveButton("Ya", (DialogInterface.OnClickListener) (dialog, which) -> {
                            ...
                            sqliteHelper.deleteBarangMasuk(theList.get(position).getId());
                            theList.remove(position);
                            CustomAdapterMasuk listAdapterRmv = new CustomAdapterMasuk(DataBarangMasukActivity.this, theList);
                            listView.setAdapter(listAdapterRmv);
                            listAdapter.notifyDataSetChanged();

                            Snackbar.make(listView,"Hapus Data Berhasil", Snackbar.LENGTH_LONG).show();
                            Cursor datas = sqliteHelper.getAllBarangMasuk();
                            if (datas.getCount()==0){
                                emptyState.setVisibility(View.VISIBLE);
                                return;
                            }else {
    ...
    public boolean onQueryTextChange(String newText) {
        String text = newText;
        SqliteHelper sqliteHelper = new SqliteHelper(getBaseContext());
        Cursor data = sqliteHelper.searchBarangMasuk(text);
        if(text.equals("")){
            theList.clear();
            initData();
        }else{
    ...
    private void initCustomDialog(ModelBarangMasuk barang){
        customDialog = new Dialog(DataBarangMasukActivity.this);
        ...
        sqliteHelper = new SqliteHelper(DataBarangMasukActivity.this);
        ...
        btnEdit.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                if(BarangSpinner.getSelectedItem().toString().equals("Pilih Kode Barang") || SupplierSpinner.getSelectedItem().toString().equals("Pilih Supplier") || tglMasuk.equals("")){
                    ...
                    nDialog = new ProgressDialog(DataBarangMasukActivity.this);
                    nDialog.setMessage("Loading...");
                    nDialog.setTitle("Edit data barang masuk");
                    nDialog.setIndeterminate(false);
                    nDialog.setCancelable(false);
                    nDialog.setCanceledOnTouchOutside(false);
                    nDialog.show();
                    boolean rowAffect = sqliteHelper.editBarangMasuk(barang.getId(),responseBarang.get(BarangSpinner.getSelectedItemPosition()-1).getId(), tglMasuk,responseSupplier.get(SupplierSpinner.getSelectedItemPosition()-1).getId());
                    if(rowAffect){
                        new Handler().postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if (datas.getCount()==0){
                                    ...
                                    CustomAdapterMasuk listAdapters = new CustomAdapterMasuk(DataBarangMasukActivity.this, theList);
